            ...
            <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={`
                flex items-center gap-4 pl-9 pr-6 py-3.5 rounded-xl text-[15px] font-medium transition-all min-h-[48px] relative overflow-hidden group
                ${isActive
              ...
              `}
                        >
                            ...
                            {isActive && <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#8F8DFF] rounded-r-full" />}
                        </Link>
                    );
                })}
                ...
                {isAdmin && (
                    <Link
                        href="/admin"
                        className={`
              flex items-center gap-4 pl-9 pr-6 py-3.5 rounded-xl text-[15px] font-medium transition-all min-h-[48px]
              ${pathname === '/admin'
