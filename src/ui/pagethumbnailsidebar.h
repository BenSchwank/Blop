...
// on the right edge of the editor. Clicking a thumbnail jumps to that page.
// A quiet "+" control at the bottom appends a blank page. Collapsible so the
// canvas can go full-bleed when the rail is not needed.
